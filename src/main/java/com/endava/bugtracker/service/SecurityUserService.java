...
import com.endava.bugtracker.repository.UserRepository;
...
public class SecurityUserService implements UserService {
    ...
    @Autowired
    public SecurityUserService(PasswordEncoder passwordEncoder, UserRepository repository) {
    ...
    public User registerNewUserAccount(RegistrationForm userAccountData) throws ExistingEmailException {
        ...
        if (emailExist(userAccountData.getEmail())) {
            ...
            throw new ExistingEmailException("The email address: " + userAccountData.getEmail() + " is already in use.");
        }
